	...
	implements com.jcraft.jsch.GSSContext
{
	...
	public void create (String user, String host) throws JSchException {
		...
		serverKrbName = SspiUtils.getServicePrincipalName ("host", host);

		// Destroy any old handle that's hanging around.
		SspiUtils.dispose (this.credHandle);
	...
	public byte[] getMIC(byte[] message, int s, int l) {
		...
		return SspiUtils.makeSignature (contextHandle, input, 0);
	}
